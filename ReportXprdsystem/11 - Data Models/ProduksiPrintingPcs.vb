...
Namespace HSP.Data
    Public Class ProduksiPrintingPcs
    ...
    Public Class DaftarProduksiPrintingPcs
        ...
        'Add
        '------------------------------------------------------------------------------------------------------------------
        Public Function Add(ByVal Data As ProduksiPrintingPcs) As Integer
            Dim SQL As String

            SQL = "INSERT INTO produksiprintingpcs" +
                  "     (RowID, " +
        ...
        Public Function GetNomorTransaksi(ByVal Periode As String) As String
            ...
            Using DBX As IDbConnection = _DBConnection.Connection()
                ...
                'Nomor Transaksi
                '------------------------------------------------------------------------------------------
                SQL = "SELECT COUNT(*) AS Total FROM produksiprintingpcs " +
