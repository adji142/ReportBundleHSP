...
Namespace HSP.Data
    Public Class HeaderPenyerahanHasilProduksi
    ...
    Public Class DetailPenyerahanHasilProduksi
        Public Property RowID As String
        Public Property NoTransaksi As String
    ...
    Public Class DaftarPenyerahanHasilProduksi
        ...
        Public Function AddHeader(ByVal Data As HeaderPenyerahanHasilProduksi) As Integer
            Dim SQL As String

            SQL = "INSERT INTO headerpenyerahanhasilproduksi " +
        ...
        Public Function FindHeader(ByVal ID As String) As HeaderPenyerahanHasilProduksi
            Dim SQL As String

            SQL = "SELECT * FROM headerpenyerahanhasilproduksi " +
                  "WHERE NoTransaksi = @NoTransaksi "

            Using DBX As IDbConnection = _DBConnection.Connection
                FindHeader = DBX.Query(Of HeaderPenyerahanHasilProduksi)(SQL, New With {.NoTransaksi = ID}).FirstOrDefault
            End Using
        End Function

        Public Function AddDetail(ByVal Data As DetailPenyerahanHasilProduksi) As Integer
            Dim SQL As String

            SQL = "INSERT INTO detailpenyerahanhasilproduksi " +
        ...
        Public Function DeleteDetail(ByVal ID As String) As Integer
            ...
            SQL = "DELETE FROM detailpenyerahanhasilproduksi " +
                  "WHERE NoTransaksi = @NoTransaksi"
        ...
        Public Function FindByKodeProduksi(ByVal KodeProduksi As String, ByVal Kelompok As Byte) As DetailPenyerahanHasilProduksi
            Dim SQL As String

            SQL = "SELECT * FROM detailpenyerahanhasilproduksi " +
                  "WHERE StatusStock=1 AND KodeProduksi = @KodeProduksi AND Kelompok = '" & Kelompok & "' "

            Using DBX As IDbConnection = _DBConnection.Connection
                FindByKodeProduksi = DBX.Query(Of DetailPenyerahanHasilProduksi)(SQL, New With {.KodeProduksi = KodeProduksi}).FirstOrDefault
            End Using
        End Function
        ...
        Public Function GetNomorTransaksi(ByVal Periode As String) As String
            ...
            Using DBX As IDbConnection = _DBConnection.Connection()
                ...
                'Nomor Transaksi
                '------------------------------------------------------------------------------------------
                SQL = "SELECT COUNT(*) AS Total FROM headerpenyerahanhasilproduksi " +
