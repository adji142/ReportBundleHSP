...
Public Class frmRPT329_150_PackingKarung
    ...
    Private Sub frmReport_Load(ByVal sender As Object, ByVal e As EventArgs) Handles MyBase.Load
        ...
        cboKodeUnit.ComboBox.SelectedValue = GetSetting(enumFormID.frmPackingKarung, enumSetting.settingKodeUnit)
    ...
    Private Sub btRefresh_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btRefresh.Click
        ...
        Select Case cboLaporan.SelectedIndex + 1
            Case 1
                RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\Reports\rpt329151_PenyelesaianWO_PackingKarung.RPT")
        End Select
