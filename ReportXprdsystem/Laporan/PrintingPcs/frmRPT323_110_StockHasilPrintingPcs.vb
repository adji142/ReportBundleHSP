...
Public Class frmRPT323_110_StockHasilPrintingPcs
    ...
    Private Sub btRefresh_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btRefresh.Click
        ...
        'Report
        RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\Reports\rpt323111_StockHasilPrintingPcs.RPT")
        ...
        'Parameter
        RPTObject.ParameterFields("KODELOKASI").CurrentValues.AddValue(GetSetting(enumFormID.frmJahitManual, enumSetting.settingKodeLokasi))
