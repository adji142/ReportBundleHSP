...
Public Class frmRPT312_150_CementBag
    ...
    Private Sub frmReport_Load(ByVal sender As Object, ByVal e As EventArgs) Handles MyBase.Load
        ...
        cboKodeUnit.ComboBox.SelectedValue = GetSetting(enumFormID.frmSemenBag, enumSetting.settingKodeUnit)
    ...
    Private Sub btRefresh_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btRefresh.Click
        ...
        Select Case cboLaporan.SelectedIndex + 1
            Case 1
                RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\Reports\rpt312151_PenyelesaianWO_CementBag.RPT")
        End Select
