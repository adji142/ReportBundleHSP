...
Public Class frmRPT329_120_DaftarItem
    ...
    Private Sub btRefresh_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btRefresh.Click
        ...
        Select Case cboLaporan.SelectedIndex + 1
            Case 1
                RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\Reports\RPT329121_DaftarItem.RPT")
        End Select
        ...
        'Parameter
        RPTObject.ParameterFields("KODEUNIT").CurrentValues.AddValue(New DaftarUnitProduksi(ActiveSession).Find(GetSetting(enumFormID.frmPackingKarung, enumSetting.settingKodeUnit)).KodeUnitSAP)
