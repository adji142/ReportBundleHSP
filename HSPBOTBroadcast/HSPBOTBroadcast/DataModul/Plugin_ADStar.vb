...
Public Class Plugin_ADStar
    ...
    Public Sub Execute()
        ...
        Dim Title = "LAPORAN HASIL CEMENT BAG" + vbCrLf + "Per " + _Date.ToString("dd/MM/yyyy hh:mm")
    ...
    Public Function _Create()
        Try
            ...
            FileName = "Lap.HasilSB" & Now.Ticks.ToString & ".PDF"
            ...
            RPTObject.Load("C:\BOT\rpt312131_HasilCementBag.rpt")
            ...
            RPTObject.ParameterFields("Mesin").CurrentValues.AddValue("")
