...
Public Class Plugin_saldoAgingPiutangAJT
    ...
    Public Sub Execute()
        ...
        Dim Title = "Laporan Aging Piutang Akan Jatuh Tempo" + vbCrLf + "Per " + _Date.ToString("dd/MM/yyyy hh:mm")
    ...
    Public Function _Create()
        Try
            ...
            FileName = "AgingPiutangAJT" & Now.Ticks.ToString & ".PDF"
            ...
            RPTObject.Load("C:\BOT\Rpt_AgingPiutangAkanJT.rpt")
            ...
            RPTObject.ParameterFields("TglJatuhTempo@").CurrentValues.AddValue(Date.Now)
            'RPTObject.ParameterFields("Transaksi@").CurrentValues.AddValue(0)
