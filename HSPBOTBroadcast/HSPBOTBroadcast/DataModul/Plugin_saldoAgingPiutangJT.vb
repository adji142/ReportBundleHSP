...
Public Class Plugin_saldoAgingPiutangJT
    ...
    Public Sub Execute()
        ...
        Dim Title = "Laporan Aging Piutang Jatuh Tempo" + vbCrLf + "Per " + _Date.ToString("dd/MM/yyyy hh:mm")
    ...
    Public Function _Create()
        Try
            ...
            FileName = "AgingPiutangJT" & Now.Ticks.ToString & ".PDF"
            ...
            RPTObject.Load("C:\BOT\Rpt_AgingPiutangJT.rpt")
