...
Module mdlSetting
    ...
    Public Sub SaveSetting(FormID As enumFormID, Setting As enumSetting, Value As String)
        ...
        RegKey.CreateSubKey("ReportBundleHSP\Setting")
        RegKey.Close()

        RegKey = Registry.CurrentUser.OpenSubKey("Software\ReportBundleHSP\Setting", True)
    ...
    Public Function GetSetting(FormID As enumFormID, Setting As enumSetting) As String
        ...
        If Registry.CurrentUser.OpenSubKey("Software\ReportBundleHSP\Setting") IsNot Nothing Then
            RegKey = Registry.CurrentUser.OpenSubKey("Software\ReportBundleHSP\Setting", True)
