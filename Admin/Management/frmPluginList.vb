...
' ---------------------------------------------------------------------------------------------------------
' Nama File   : frmPluginList.vb
' Deskripsi   : Form Untuk Menampilkan Daftar Plugin
...
Public Class frmPluginList

    'Form Load
    Private Sub frmPluginList_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    'Form Show
    Private Sub frmPluginList_Shown(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Shown
        Me.Refresh()
    ...
    'Form Closing
    Private Sub frmPluginList_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
    ...
    Private Sub ShowData(Optional ByVal ID As String = "")
        ...
        Dim DataSet As DataSet = PluginList.Read(txtCariData.Text)
    ...
    Private Sub frmPluginList_KeyDown(ByVal sender As Object, ByVal e As KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub Execute(ByVal ID As String)
        ...
        Select Case ID
            ...
            Case "btEdit", "btEditCTXM"
                ...
                '---------------------------------------------------------------------------------------------------------
                Dim FormEdit As New frmPlugin(DataKey)
                FormEdit.ShowDialog()
            ...
            Case "btDelete", "btDeleteCTXM"
                ...
                '---------------------------------------------------------------------------------------------------------
                Dim DKP As New pluginList(ActiveSession)
