...
Public Class frmDaftarPemakaianBahanEx
    ...
    Private Sub Execute(ByVal ID As String)
        ...
        Select Case ID
            Case "btAdd", "btAddCTXM"
                ...
                '---------------------------------------------------------------------------------------------------------
                Dim FormAdd As New frmPemakaianBahanEx("", cboKodeUnit.ComboBox.SelectedValue.ToString)
                FormAdd.ShowDialog()
            ...
            Case "btEdit", "btEditCTXM"
                ...
                Dim FormEdit As New frmPemakaianBahanEx(DataKey, cboKodeUnit.ComboBox.SelectedValue)
                FormEdit.ShowDialog()
