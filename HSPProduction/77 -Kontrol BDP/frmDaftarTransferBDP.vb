...
Public Class frmDaftarTransferBDP
    ...
    'Form Load
    Private Sub frmDaftarTransferBDP_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    'Form Show
    Private Sub frmDaftarTransferBDP_Shown(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Shown
        Me.Refresh()
    ...
    'Form Closing
    Private Sub frmDaftarTransferBDP_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
    ...
    Private Sub ShowData(Optional ByVal ID As String = "")
        ...
        Dim DataSet As DataSet = DaftarTransferBDP.ReadTransaction(txtTglAwal.Value.Date, txtTglAkhir.Value.Date, txtCariData.Text, cboKodeUnit.ComboBox.SelectedValue.ToString)
    ...
    Private Sub frmDaftarTransferBDP_KeyDown(ByVal sender As Object, ByVal e As KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub Execute(ByVal ID As String)
        ...
        Select Case ID
            Case "btAdd", "btAddCTXM"
                ...
                '---------------------------------------------------------------------------------------------------------
                Dim FormAdd As New frmTransferBDP("", cboKodeUnit.ComboBox.SelectedValue)
                FormAdd.ShowDialog()
            ...
            Case "btEdit", "btEditCTXM"
                ...
                'Dim FormEdit As New frmTransferBDP(DataKey, cboKodeUnit.ComboBox.SelectedValue)
                'FormEdit.ShowDialog()
