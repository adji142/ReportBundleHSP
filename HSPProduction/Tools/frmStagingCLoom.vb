...
Public Class frmStagingCLoom
    ...
    Private Sub ShowDataStaging()
        ...
        Dim DataSet As DataSet = SAP.Read(txtTanggal.Value.Date, SAPStaging.enumTransaksiStaging.PemakaianBahanCLoom)
    ...
    Private Sub ShowDataConsole()
        ...
        'Baca Data
        Dim DataC As New DaftarPengeluaranBenang(ActiveSession)
