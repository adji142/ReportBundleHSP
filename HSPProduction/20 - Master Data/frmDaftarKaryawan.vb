...
Public Class frmDaftarKaryawan
    ...
    Private Sub FillCombo()
        ...
        cboKodeUnit.ComboBox.SelectedIndex = cboKodeUnit.ComboBox.Items.Count - 1
    End Sub
    ...
    Private Sub ShowData(Optional ByVal ID As String = "")
        ...
        Dim DataSet As DataSet = DaftarKaryawan.Read(txtCariData.Text, cboKodeUnit.ComboBox.SelectedValue)
    ...
    Private Sub Execute(ByVal ID As String)
        ...
        Dim GroupKey As String = cboKodeUnit.ComboBox.SelectedValue
        ...
        Select Case ID
            Case "btAdd", "btAddCTXM"
                ...
                '---------------------------------------------------------------------------------------------------------
                Dim FormAdd As New frmKaryawan("", GroupKey)
                FormAdd.ShowDialog()
            ...
            Case "btEdit", "btEditCTXM"
                ...
                '---------------------------------------------------------------------------------------------------------
                Dim FormEdit As New frmKaryawan(DataKey, GroupKey)
                FormEdit.ShowDialog()
            ...
            Case "btDelete", "btDeleteCTXM"
                ...
                If DaftarKaryawan.Locked(View(0, View.CurrentCell.RowIndex).Value) Then
                ...
                Else
                    ...
                    If MessageBox.Show("Hapus Data Baris Ini ? ", "Konfirmasi", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then
                        DaftarKaryawan.Delete(View(0, View.CurrentCell.RowIndex).Value)
