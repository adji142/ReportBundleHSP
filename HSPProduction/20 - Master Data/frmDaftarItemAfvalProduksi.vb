...
Public Class frmDaftarItemPemakaianProduksi

    'Form Load
    Private Sub frmDaftarArea_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub FillCombo()
        ...
        Dim DS1 As DataSet = DaftarUnitProduksi.Read("%")
        cboUnitProduksi.ComboBox.DataSource = DS1.Tables("View")
        ...
        Dim Drow1 As DataRow = DS1.Tables("View").Rows.Add()
        Drow1("Kode") = ""
        Drow1("Unit Produksi") = "<Seluruh Unit Produksi>"
    ...
    'Form Show
    Private Sub frmDaftarArea_Shown(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Shown
        Me.Refresh()
    ...
    'Form Closing
    Private Sub frmDaftarArea_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
    ...
    Private Sub ShowData(Optional ByVal ID As String = "")
        ...
        Dim DataSet As DataSet = DaftarItem.Read(txtCariData.Text, "600", cboUnitProduksi.ComboBox.SelectedValue)
    ...
    Private Sub frmDaftarArea_KeyDown(ByVal sender As Object, ByVal e As KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub Execute(ByVal ID As String)
        ...
        Select Case ID
            Case "btAdd", "btAddCTXM"
                ...
                '---------------------------------------------------------------------------------------------------------
                Dim FormAdd As New frmItemPemakaianProduksi("", GroupKey)
                FormAdd.ShowDialog()
            ...
            Case "btEdit", "btEditCTXM"
                ...
                '---------------------------------------------------------------------------------------------------------
                Dim FormEdit As New frmItemPemakaianProduksi(DataKey, GroupKey)
                FormEdit.ShowDialog()
            ...
            Case "btDelete", "btDeleteCTXM"
                ...
                If DaftarItem.Locked(View(0, View.CurrentCell.RowIndex).Value) Then
                ...
                Else
                    ...
                    If MessageBox.Show("Hapus Data Baris Ini ? ", "Konfirmasi", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then
                        DaftarItem.Delete(View(0, View.CurrentCell.RowIndex).Value)
