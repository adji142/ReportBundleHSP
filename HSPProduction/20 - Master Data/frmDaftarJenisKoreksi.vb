...
Public Class frmDaftarJenisKoreksi

    'Form Load
    Private Sub frmDaftarJenisKoreksi_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub FillCombo()
        ...
        Dim DS As DataSet = DaftarKelompokKoreksi.Read("%")
        ...
        Drow("Kode") = ""
        Drow("Nama Kelompok") = "<Seluruh Kelompok>"

        cboKelompok.ComboBox.SelectedIndex = cboKelompok.ComboBox.Items.Count - 1
    End Sub
    ...
    'Form Show
    Private Sub frmDaftarJenisKoreksi_Shown(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Shown
        Me.Refresh()
    ...
    'Form Closing
    Private Sub frmDaftarJenisKoreksi_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
    ...
    Private Sub ShowData(Optional ByVal ID As String = "")
        ...
        Dim DataSet As DataSet = DaftarJenisKoreksi.Read(txtCariData.Text, cboKelompok.ComboBox.SelectedValue)
    ...
    Private Sub frmDaftarJenisKoreksi_KeyDown(ByVal sender As Object, ByVal e As KeyEventArgs) Handles Me.KeyDown
    ...
    'Jika JenisKoreksi View Ditekan Tombol Tertentu
    ...
    Private Sub Execute(ByVal ID As String)
        ...
        Dim GroupKey As String = cboKelompok.ComboBox.SelectedValue
        ...
        Select Case ID
            Case "btAdd", "btAddCTXM"
                ...
                '---------------------------------------------------------------------------------------------------------
                Dim FormAdd As New frmJenisKoreksi("", GroupKey)
                FormAdd.ShowDialog()
            ...
            Case "btEdit", "btEditCTXM"
                ...
                '---------------------------------------------------------------------------------------------------------
                Dim FormEdit As New frmJenisKoreksi(DataKey, GroupKey)
                FormEdit.ShowDialog()
            ...
            Case "btDelete", "btDeleteCTXM"
                ...
                If DaftarJenisKoreksi.Locked(View(0, View.CurrentCell.RowIndex).Value) Then
                ...
                Else
                    ...
                    If MessageBox.Show("Hapus Data Baris Ini ? ", "Konfirmasi", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then
                        DaftarJenisKoreksi.Delete(View(0, View.CurrentCell.RowIndex).Value)
