...
Public Class frmDaftarMesinProduksi

    'Form Load
    Private Sub frmDaftarMesin_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    'Form Show
    Private Sub frmDaftarMesin_Shown(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Shown
        Me.Refresh()
    ...
    'Form Closing
    Private Sub frmDaftarMesin_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
    ...
    Private Sub ShowData(Optional ByVal ID As String = "")
        ...
        Dim DataSet As DataSet = DaftarMesin.Read(txtCariData.Text, cboUnitProduksi.ComboBox.SelectedValue)
    ...
    Private Sub frmDaftarMesin_KeyDown(ByVal sender As Object, ByVal e As KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub Execute(ByVal ID As String)
        ...
        Select Case ID
            Case "btAdd", "btAddCTXM"
                ...
                '---------------------------------------------------------------------------------------------------------
                Dim FormAdd As New frmMesin("", GroupKey)
                FormAdd.ShowDialog()
            ...
            Case "btEdit", "btEditCTXM"
                ...
                '---------------------------------------------------------------------------------------------------------
                Dim FormEdit As New frmMesin(DataKey, GroupKey)
                FormEdit.ShowDialog()
            ...
            Case "btDelete", "btDeleteCTXM"
                ...
                If DaftarMesin.Locked(View(0, View.CurrentCell.RowIndex).Value) Then
                ...
                Else
                    ...
                    If MessageBox.Show("Hapus Data Baris Ini ? ", "Konfirmasi", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then
                        DaftarMesin.Delete(View(0, View.CurrentCell.RowIndex).Value)
