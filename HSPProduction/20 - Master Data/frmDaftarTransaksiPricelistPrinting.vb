...
Public Class frmDaftarTransaksiPricelistPrinting

    'Form Load
    Private Sub frmDaftarTransaksiPricelist_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    'Form Show
    Private Sub frmDaftarTransaksiPricelist_Shown(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Shown
        Me.Refresh()
    ...
    'Form Closing
    Private Sub frmDaftarTransaksiPricelist_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
    ...
    Private Sub ShowData(Optional ByVal ID As String = "")
        ...
        Dim DataSet As DataSet = DaftarTransaksiPricelist.Read(txtCariData.Text)
    ...
    Private Sub frmDaftarTransaksiPricelist_KeyDown(ByVal sender As Object, ByVal e As KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub Execute(ByVal ID As String)
        ...
        Select Case ID
            Case "btAdd", "btAddCTXM"
                ...
                '---------------------------------------------------------------------------------------------------------
                Dim FormAdd As New frmPriceListPrinting("")
                FormAdd.ShowDialog()
            ...
            Case "btEdit", "btEditCTXM"
                ...
                '---------------------------------------------------------------------------------------------------------
                Dim FormEdit As New frmPriceListPrinting(DataKey)
                FormEdit.ShowDialog()
                ...
                '    If DaftarTransaksiPricelist.Locked(View(0, View.CurrentCell.RowIndex).Value) Then
                ...
                '            DaftarTransaksiPricelist.Delete(View(0, View.CurrentCell.RowIndex).Value)
