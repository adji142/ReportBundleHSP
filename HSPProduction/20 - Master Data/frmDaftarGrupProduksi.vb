...
Public Class frmDaftarGrupProduksi

    'Form Load
    Private Sub frmDaftarGrupProduksi_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    'Form Show
    Private Sub frmDaftarGrupProduksi_Shown(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Shown
        Me.Refresh()
    ...
    'Form Closing
    Private Sub frmDaftarGrupProduksi_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
    ...
    Private Sub ShowData(Optional ByVal ID As String = "")
        ...
        Dim DataSet As DataSet = DaftarGrupProduksi.Read(txtCariData.Text)
    ...
    Private Sub frmDaftarGrupProduksi_KeyDown(ByVal sender As Object, ByVal e As KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub Execute(ByVal ID As String)
        ...
        Select Case ID
            Case "btAdd", "btAddCTXM"
                ...
                '---------------------------------------------------------------------------------------------------------
                Dim FormAdd As New frmGrupProduksi("")
                FormAdd.ShowDialog()
            ...
            Case "btEdit", "btEditCTXM"
                ...
                '---------------------------------------------------------------------------------------------------------
                Dim FormEdit As New frmGrupProduksi(DataKey)
                FormEdit.ShowDialog()
            ...
            Case "btDelete", "btDeleteCTXM"
                ...
                If DaftarGrupProduksi.Locked(View(0, View.CurrentCell.RowIndex).Value) Then
                ...
                Else
                    ...
                    If MessageBox.Show("Hapus Data Baris Ini ? ", "Konfirmasi", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then
                        DaftarGrupProduksi.Delete(View(0, View.CurrentCell.RowIndex).Value)
