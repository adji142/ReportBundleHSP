...
Public Class frmDaftarPolaMediaTimbang

    'Form Load
    Private Sub frmDaftarPolaMediaTimbang_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub FillCombo()
        ...
        Dim DS As DataSet = DaftarLokasiProduksi.Read("%")
        ...
        Drow("Kode") = ""
        Drow("Nama Lokasi") = "<Seluruh Lokasi>"

        cboKodeLokasi.ComboBox.SelectedIndex = cboKodeLokasi.ComboBox.Items.Count - 1
    End Sub
    ...
    'Form Show
    Private Sub frmDaftarPolaMediaTimbang_Shown(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Shown
        Me.Refresh()
    ...
    'Form Closing
    Private Sub frmDaftarPolaMediaTimbang_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
    ...
    Private Sub ShowData(Optional ByVal ID As String = "")
        ...
        Dim DataSet As DataSet = DaftarPolaMediaTimbang.Read(txtCariData.Text, cboKodeLokasi.ComboBox.SelectedValue)
    ...
    Private Sub frmDaftarPolaMediaTimbang_KeyDown(ByVal sender As Object, ByVal e As KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub Execute(ByVal ID As String)
        ...
        Dim GroupKey As String = cboKodeLokasi.ComboBox.SelectedValue
        ...
        Select Case ID
            Case "btAdd", "btAddCTXM"
                ...
                '---------------------------------------------------------------------------------------------------------
                Dim FormAdd As New frmPolaMediaTimbang("", GroupKey)
                FormAdd.ShowDialog()
            ...
            Case "btEdit", "btEditCTXM"
                ...
                '---------------------------------------------------------------------------------------------------------
                Dim FormEdit As New frmPolaMediaTimbang(DataKey, GroupKey)
                FormEdit.ShowDialog()
            ...
            Case "btDelete", "btDeleteCTXM"
                ...
                If DaftarPolaMediaTimbang.Locked(View(0, View.CurrentCell.RowIndex).Value) Then
                ...
                Else
                    ...
                    If MessageBox.Show("Hapus Data Baris Ini ? ", "Konfirmasi", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then
                        DaftarPolaMediaTimbang.Delete(View(0, View.CurrentCell.RowIndex).Value)
