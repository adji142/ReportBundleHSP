...
Public Class frmDaftarParameterExtruder
    'Form Load
    Private Sub frmDaftarParameterExtruder_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    'Form Show
    Private Sub frmDaftarParameterExtruder_Shown(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Shown
        Me.Refresh()
    ...
    'Form Closing
    Private Sub frmDaftarParameterExtruder_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
    ...
    Private Sub ShowData(Optional ByVal ID As String = "")
        ...
        'Baca Data
        Dim DaftarPRL As New DaftarParameterExtruder(ActiveSession)
    ...
    Private Sub frmDaftarParameterExtruder_KeyDown(ByVal sender As Object, ByVal e As KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub Execute(ByVal ID As String)
        ...
        Select Case ID
            Case "btAdd", "btAddCTXM"
                ...
                '---------------------------------------------------------------------------------------------------------
                Dim FormAdd As New frmParameterExtruder("")
                FormAdd.ShowDialog()
            ...
            Case "btEdit", "btEditCTXM"
                ...
                Dim FormEdit As New frmParameterExtruder(DataKey)
                FormEdit.ShowDialog()
