...
Public Class frmPriceListPrinting
    Private Const _Lebar = 0
    Private Const _Panjang = 1
    Private Const _Warna = 2
    Private Const _Sisi = 3
    Private Const _WarnaPrinting = 4
    Private Const _Harga1 = 5
    Private Const _Harga2 = 6
    Private Const _Harga3 = 7
    ...
    Private Sub SetKolomHeader()
        ...
        Grid.AddColumnHeader("Lebar", 12, 0, GridColumnStyle.csFixed, GridColumnType.ctText, GridColumnAlignment.caCenter, False)
        Grid.AddColumnHeader("Panjang Karung", 15, 0, GridColumnStyle.csFixed, GridColumnType.ctText, GridColumnAlignment.caCenter, False)
        Grid.AddColumnHeader("Warna", 10, 0, GridColumnStyle.csFixed, GridColumnType.ctText, GridColumnAlignment.caCenter, False)
        Grid.AddColumnHeader("Sisi Print", 10, 0, GridColumnStyle.csFixed, GridColumnType.ctText, GridColumnAlignment.caCenter, False)
        Grid.AddColumnHeader("Warna Print", 10, 0, GridColumnStyle.csFixed, GridColumnType.ctText, GridColumnAlignment.caCenter, False)
        Grid.AddColumnHeader("Harga 1", 12, 0, GridColumnStyle.csInput, GridColumnType.ctDecimal, GridColumnAlignment.caRight, False, Color.LightYellow, Color.Black, "##,##0.00")
        Grid.AddColumnHeader("Harga 2", 12, 0, GridColumnStyle.csInput, GridColumnType.ctDecimal, GridColumnAlignment.caRight, False, Color.LightYellow, Color.Black, "##,##0.00")
        Grid.AddColumnHeader("Harga 3", 12, 0, GridColumnStyle.csInput, GridColumnType.ctDecimal, GridColumnAlignment.caRight, False, Color.LightYellow, Color.Black, "##,##0.00")
    ...
    Private Sub FillCombo()
        ...
        DS = New DataSet
        DS = DaftarSAPKelompokItem.ReadKelompok("202,203,204,207,208,209,212,213,214")
    ...
    Private Sub btTampilData_Click(sender As Object, e As EventArgs) Handles btTampilData.Click
        Dim TPL As New DaftarTransaksiPricelistPrinting(ActiveSession)
        Dim PL As TransaksiPricelistPrinting = TPL.Find(cboKelompok.SelectedValue, cboJenisKarung.SelectedValue, cboDenier.SelectedValue, cboBrand.SelectedValue)
        If Not IsNothing(PL) Then
            ...
            For Each DR As DataRow In DT.Rows
                ...
                Grid.GridValue(_Sisi, Row) = DR("JmlSisiPrt")
                Grid.GridValue(_WarnaPrinting, Row) = DR("JmlWrnPrt")
                Grid.GridValue(_Harga1, Row) = DR("Harga1")
                Grid.GridValue(_Harga2, Row) = DR("Harga2")
                Grid.GridValue(_Harga3, Row) = DR("Harga3")
        ...
        Else
            ...
            DT = DaftarSAPItemBarang.Read(cboKelompok.SelectedValue, cboJenisKarung.SelectedValue, cboDenier.SelectedValue, cboBrand.SelectedValue, True).Tables("View")
            Grid.Clear()
            ...
            For Each DR As DataRow In DT.Rows
                ...
                Grid.GridValue(_Warna, Row) = DR("Warna")
                Grid.GridValue(_Sisi, Row) = DR("Sisi")
                Grid.GridValue(_WarnaPrinting, Row) = DR("WrnPrint")
                Row += 1
            Next
        End If
        ...
        Select Case DirectCast(sender, Button).Name
            Case "btSave"
                ...
                Try
                    ...
                    Dim DaftarTransaksiPricelist As New DaftarTransaksiPricelistPrinting(ActiveSession)
                    Dim TransaksiPricelist As TransaksiPricelistPrinting
                    Dim DaftarPricelist As New DaftarPriceListPrinting(ActiveSession)
                    Dim Pricelist As PriceListPrinting
                    ...
                    For nRow = 0 To Grid.GridLastRow - 1
                        If Grid.GridValue(_Lebar, nRow) <> "" Then
                            ...
                            Dim DT As DataTable = SAPItemBarang.ReadItem(cboKelompok.SelectedValue, _
                                                                         ...
                                                                         Grid.GridValue(_Sisi, nRow), _
                                                                         Grid.GridValue(_WarnaPrinting, nRow)).Tables("View")
                            Dim DR As DataRow
                            Dim Row As Integer = 0

                            For Each DR In DT.Rows
                                'Transaksi
                                TransaksiPricelist = New TransaksiPricelistPrinting
                                ...
                                TransaksiPricelist.Harga1 = Grid.GridValue(_Harga1, nRow)
                                TransaksiPricelist.Harga2 = Grid.GridValue(_Harga2, nRow)
                                TransaksiPricelist.Harga3 = Grid.GridValue(_Harga3, nRow)
                                ...
                                TransaksiPricelist.JmlSisiPrt = Grid.GridValue(_Sisi, nRow)
                                TransaksiPricelist.JmlWrnPrt = Grid.GridValue(_WarnaPrinting, nRow)
                                TransaksiPricelist.Jahit = ""
                                ...
                                Pricelist = New PriceListPrinting
                                Pricelist.KodeItem = DR("KodeItem")
                                Pricelist.NamaItem = DR("NamaItem")
                                Pricelist.Harga1 = Grid.GridValue(_Harga1, nRow)
                                Pricelist.Harga2 = Grid.GridValue(_Harga2, nRow)
                                Pricelist.Harga3 = Grid.GridValue(_Harga3, nRow)
...
Jump:
    ...
    Private Sub txtNoTransaksi_Validating(sender As Object, e As System.ComponentModel.CancelEventArgs) Handles txtNoTransaksi.Validating
        ...
        If txtNoTransaksi.Text <> "" Then
            Dim DaftarTransaksiPricelist As New DaftarTransaksiPricelistPrinting(ActiveSession)
            Dim TransaksiPricelist As TransaksiPricelistPrinting = DaftarTransaksiPricelist.Find(txtNoTransaksi.Text)
            If Not IsNothing(TransaksiPricelist) Then
