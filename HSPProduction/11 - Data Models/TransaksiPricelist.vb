...
Namespace HSP.Data
    Public Class TransaksiPricelist
    ...
    Public Class DaftarTransaksiPricelist
        ...
        Public Function Add(ByVal Data As TransaksiPricelist) As Integer
            Dim SQL As String

            SQL = "INSERT INTO transaksipricelist " +
                  "(NoTransaksi, TglTransaksi, KodeItem, NamaItem, Harga1, Harga2, Harga3, Harga4, Kelompok, Jenis, Denier, Merek, Lebar, Panjang, Warna, Printing) " +
                  "VALUES " +
                  "(@NoTransaksi, @TglTransaksi, @KodeItem, @NamaItem, @Harga1, @Harga2, @Harga3, @Harga4, @Kelompok, @Jenis, @Denier, @Merek, @Lebar, @Panjang, @Warna, @Printing)"
        ...
        Public Function Delete(ByVal ID As String) As Integer
            ...
            SQL = "DELETE FROM transaksipricelist " +
        ...
        Public Function Find(ByVal ID As String) As TransaksiPricelist
            Dim SQL As String

            SQL = "SELECT * FROM transaksipricelist " +
                  "WHERE NoTransaksi = @NoTransaksi "

            Using DBX As IDbConnection = _DBConnection.Connection
                Find = DBX.Query(Of TransaksiPricelist)(SQL, New With {.NoTransaksi = ID}).FirstOrDefault
            End Using
        End Function

        Public Function Find(ByVal Kelompok As String, ByVal JenisBenang As String, ByVal Denier As String, ByVal Brand As String) As TransaksiPricelist
            Dim SQL As String
            ...
            Using DBX As IDbConnection = _DBConnection.Connection
                Find = DBX.Query(Of TransaksiPricelist)(SQL).FirstOrDefault
            End Using
        End Function
        ...
        Public Function GetNomorTransaksi(ByVal Periode As String) As String
            ...
            Using DBX As IDbConnection = _DBConnection.Connection()
                ...
                'Nomor Transaksi
                '------------------------------------------------------------------------------------------
                SQL = "SELECT COUNT(*) AS Total FROM transaksipricelist " +
