...
Public Class frmExecuteFGIssue
    ...
    Private Sub btSave_Click(sender As Object, e As EventArgs) Handles btSave.Click
        ...
        SAP.UpdateStagingFGIssue(txtNoTransaksi.Text.Trim)
        '-----------------------------------------------------------------------------------

        'Execute From Staging
        SAP.Execute(txtNoTransaksi.Text.Trim, SAPStaging.enumTransaction.FinishedGoodIssue)
