...
Public Class frmDaftarBMF
    ...
    Private Sub ShowData(Optional ByVal ID As String = "")
        ...
        Dim DataSet As DataSet = DaftarBMF.ReadAll()
    ...
    Private Sub ToolStripButton1_Click(sender As Object, e As EventArgs) Handles ToolStripButton1.Click
        ...
        For Row As Integer = 0 To View.Rows.Count - 1
            'SAP.PostFinishedGoodReceipt(New DaftarUnitProduksi(ActiveSession).Find("015").KodeUnitSAP, View.Rows(Row).Cells("NomorWO").Value, View.Rows(Row).Cells("M_TglTransaksi").Value, View.Rows(Row).Cells("KodeItem").Value, View.Rows(Row).Cells("BeratNetto").Value, View.Rows(Row).Cells("BeratNetto").Value, View.Rows(Row).Cells("KodeProduksi").Value, "", View.Rows(Row).Cells("M_NoTimbang").Value)
        Next

        MsgBox("Data Benang Multifilament Berhasil Masuk Staging...")
