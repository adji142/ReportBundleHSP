...
Public Class frmProduksiPrintingRoll
...
#Region "Variable Declaration"
    ...
    Private FGPanjangPotongPrinting As Double
...
#Region "Fill Data To Combobox"
    ...
    Private Sub FillCombo()
        ...
        lblKodeUnitProduksi.Tag = GetSetting(enumFormID.frmPrintingRoll, enumSetting.settingKodeUnit)
        lblKodeLokasiHasilProduksi.Tag = GetSetting(enumFormID.frmPrintingRoll, enumSetting.settingKodeLokasi)
...
#Region "Controller"
    ...
    'Form Load
    Private Sub frmHasilProduksiPrintingRoll_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    'Form Close
    Private Sub frmHasilProduksiPrintingRoll_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
        PortTimbangan.Close()
    End Sub
    ...
    Private Sub EnterWithBlank(sender As Object, e As EventArgs) Handles txtHasilPcs.Enter, txtHasilMeter.Enter
    ...
    Private Sub cboNomorSPK_SelectedValueChanged(sender As Object, e As EventArgs) Handles cboNomorSPK.SelectedValueChanged
        ...
        If cboNomorSPK.SelectedIndex <> cboNomorSPK.Items.Count - 1 Then
            Try
                ...
                FGPanjangPotongPrinting = WO.PanjangPotongPrinting
...
ExitProcedure:
    ...
    Private Sub btTimbangHasilProduksi_Click(sender As Object, e As EventArgs) Handles btTimbangHasilProduksi.Click
        ...
        F.FormID = enumFormID.frmPrintingRoll
    ...
    Private Sub HitungProduksi()
        lblPanjangPotongPrinting.Text = FGPanjangPotongPrinting / 100
        txtHasilMeter.Value = Math.Round(txtHasilPcs.Value * (FGPanjangPotongPrinting / 100), 0)
...
Jump:
    ...
    Private Sub SetEnableCommand()
        ...
        If txtHasilPcs.Value = 0 Then
            btTimbangHasilProduksi.Enabled = False
            txtHasilTimbang.Value = 0
        Else
            btTimbangHasilProduksi.Enabled = txtHasilPcs.Enabled
        End If
...
#End Region
    ...
    Private Function CekWO(NomorWO As String) As Boolean
        ...
        QtyHasil = New DaftarProduksiPrintingRoll(ActiveSession).FindQtyHasil(NomorWO).FGPanjang + txtHasilMeter.Value
