...
Public Class frmExecuteRecycle
    ...
    Private Sub txtNoTransaksi_Validating(sender As Object, e As System.ComponentModel.CancelEventArgs) Handles txtNoTransaksi.Validating
        If txtNoTransaksi.Text <> "" Then
            ...
            Dim Data As FGReceipt = SAP.GetStagingRecycleReceipt(txtNoTransaksi.Text.Trim)
    ...
    Private Sub btSave_Click(sender As Object, e As EventArgs) Handles btSave.Click
        ...
        'SAP.UpdateStagingRecycleReceipt(txtNoTransaksi.Text.Trim)
        '-----------------------------------------------------------------------------------

        'Execute From Staging
        SAP.Execute(txtNoTransaksi.Text.Trim, SAPStaging.enumTransaction.DirectProcess)

        MessageBox.Show("Eksekusi Recycle Receipt Berhasil...")
        ResetData()
