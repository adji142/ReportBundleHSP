...
Public Class frmProduksiPackingCementBag
...
#Region "Fill Data To Combobox"
    ...
    Private Sub FillCombo()
        ...
        lblUnitProduksi.Tag = GetSetting(enumFormID.frmPackingCementBag, enumSetting.settingKodeUnit)
        lblLokasiProduksi.Tag = GetSetting(enumFormID.frmPackingCementBag, enumSetting.settingKodeLokasi)
...
#Region "Controller"
    ...
    Private Sub frmProduksiPackingCementBag_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub frmProduksiPackingCementBag_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
        ScalePort.Close()
    End Sub
...
#Region "Scale Comunication"
    ...
    Private Sub ScaleConnection()
        ...
        Try
            PortName = GetSetting(enumFormID.frmPackingCementBag, enumSetting.settingPort)
            BaudRate = GetSetting(enumFormID.frmPackingCementBag, enumSetting.settingBaudRate)
    ...
    Private Sub btSave_Click(sender As Object, e As EventArgs) Handles btSave.Click, btClose.Click, btReprint.Click
        ...
        Select Case DirectCast(sender, Button).Name
            Case "btSave"
                ...
                If MessageBox.Show("Simpan Data Proses Packing Cement Bag ?", "Konfirmasi", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.No Then
                    GoTo Jump
                End If
                ...
                Try
                    ...
                    Dim NoTransaksi As String = DaftarProduksiPackingPcs.GetNomorTransaksi(HSP.Data.ProduksiPackingPcs.enumKelompokPackingPcs.PackingCementBag, Periode)
                    ...
                    With ProduksiPackingPcs
                        .Kelompok = HSP.Data.ProduksiPackingPcs.enumKelompokPackingPcs.PackingCementBag
                    ...
                    StockPacking.Kelompok = HSP.Data.StockPacking.enumKelompokPackingPcs.PackingCementBag
