...
Public Class frmProduksiExtruderTester
    ...
    Private Sub Data_Change(sender As Object, e As EventArgs) Handles _
        ...
        If ObjectName = "cboKodeUnit" Then
            Try
                ...
                Prefik = New DaftarUnitProduksi(ActiveSession).Find(lblUnitProduksi.Tag).PrefikKodeProduksi.Trim()
        ...
        Select Case DirectCast(sender, Button).Name
            Case "btSave"
                ...
                Try
                    ...
                    Dim DaftarProduksiBenang As New DaftarStockBenangTester(ActiveSession)
                    Dim ProduksiBenang As New StockBenangTester
                    ...
                    NoUrut = DaftarProduksiBenang.GetKodeProduksi(cboKodeUnit.SelectedValue, cboKodeMesin.SelectedValue, PeriodeTransaksi, Prefik)

                    Dim nKodeProduksi As Integer
                    For nKodeProduksi = 1 To JumlahBagiMedia
                        'GetKodeProduksi(Kode Produksi/Barcode)
                        '--------------------------------------------------------------------------------------------------
                        Nomor = NoUrut.ToString.PadLeft(13 - Prefik.Length).Replace(" ", "0")
                        KodeProduksi = Prefik & PeriodeTransaksi & Nomor

                        'KodeProduksi = DaftarProduksiBenang.GetKodeProduksi(cboKodeUnit.SelectedValue, cboKodeMesin.SelectedValue, PeriodeTransaksi, Prefik)
...
#Region "Barcode Printing"
    ...
    Private Sub PrintBarcode(NoTimbang As String, Optional ReprintStatus As Boolean = False)
        Dim DaftarStockBenang As New DaftarStockBenangTester(ActiveSession)
