...
#Region "Fill Data To Combobox"
    ...
    Private Sub FillCombo()
        ...
        lblKodeUnitProduksi.Tag = GetSetting(enumFormID.frmInner, enumSetting.settingKodeUnit)
        lblKodeLokasiHasilProduksi.Tag = GetSetting(enumFormID.frmInner, enumSetting.settingKodeLokasi)
...
#Region "Controller"
    ...
    'Form Load
    Private Sub frmHasilProduksiInner_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    'Form Close
    Private Sub frmHasilProduksiInner_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
        PortTimbangan.Close()
    End Sub
    ...
    Private Sub cboNomorSPK_SelectedValueChanged(sender As Object, e As EventArgs) Handles cboNomorSPK.SelectedValueChanged
        ...
        If cboNomorSPK.SelectedIndex <> cboNomorSPK.Items.Count - 1 Then
            Try
                ...
                'Item Bahan Inner Produksi
                'Dim DT1 As DataTable = New SAPWorkOrder().ReadRMByWOBackFlush(cboNomorSPK.SelectedValue, KodeUnitSAP).Tables("View")
                'Dim DR1 As DataRow = DT1.Rows(0)

                'Label11.Text = DR1("Kode Item")
                'Label14.Text = DR1("Nama Item").ToString.ToUpper
            Catch
            End Try
        End If
    ...
    Private Sub btSave_Click(sender As Object, e As EventArgs) Handles btSave.Click, btClose.Click
        ...
        Select Case DirectCast(sender, Button).Name
            Case "btSave"
                ...
                If MessageBox.Show("Simpan Data Produksi Inner ?", "Konfirmasi", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.No Then
                    GoTo Jump
                End If
                ...
                Try
                    ...
                    Dim DaftarProduksiInner As New DaftarProduksiInner(ActiveSession)
                    Dim ProduksiInner As ProduksiInner
                    Dim UnitProduksi = New DaftarUnitProduksi(ActiveSession).Find(lblKodeUnitProduksi.Tag)

                    NoTransaksi = DaftarProduksiInner.GetNomorTransaksi(PeriodeTransaksi)
                    ...
                    If Stock < txtHasilTotal.Value Then
                        ...
                        MsgBox("Stock Bahan Utama " & lblNamaItemBahanProduksi.Text & " Tidak Mencukupi...!!!")
                    ...
                    'Item Bahan Inner Produksi
                    Dim DT As DataTable = New SAPWorkOrder().ReadRMByWOBackFlush(cboNomorSPK.SelectedValue, KodeUnitSAP).Tables("View")
                    Dim DR As DataRow = DT.Rows(0)

                    Dim KodeItemBahan As String = DR("Kode Item")
                    Dim NamaItemBahan As String = DR("Nama Item").ToString.ToUpper

                    'Cek Stock Bahan Inner
                    Dim StockInner As Double = New SAPInventory().GetCurrentStock(KodeLokasi, KodeItemBahan, "")
                    If StockInner < txtHasilTotal.Value Then
                        Me.Cursor = Cursors.Default
                        Scope.Dispose()

                        MsgBox("Stock Inner " & NamaItemBahan & " Tidak Mencukupi...!!!")
                    ...
                    ProduksiInner = New ProduksiInner
                    With ProduksiInner
                    ...
                    End With
                    DaftarProduksiInner.Add(ProduksiInner)
