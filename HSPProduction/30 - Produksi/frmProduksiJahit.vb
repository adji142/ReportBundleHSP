...
#Region "Fill Data To Combobox"
    ...
    Private Sub FillCombo()
        ...
        lblKodeUnitProduksi.Tag = GetSetting(enumFormID.frmJahitManual, enumSetting.settingKodeUnit)
        lblKodeLokasiHasilProduksi.Tag = GetSetting(enumFormID.frmJahitManual, enumSetting.settingKodeLokasi)
...
#Region "Controller"
    ...
    'Form Load
    Private Sub frmHasilProduksiJahit_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    'Form Close
    Private Sub frmHasilProduksiJahit_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
        PortTimbangan.Close()
    End Sub
    ...
    Private Sub cboNomorSPK_SelectedValueChanged(sender As Object, e As EventArgs) Handles cboNomorSPK.SelectedValueChanged
        ...
        If cboNomorSPK.SelectedIndex <> cboNomorSPK.Items.Count - 1 Then
            Try
                ...
                'lblKodeLokasiHasilProduksi.Tag = WO.KodeLokasi
                'lblKodeLokasiHasilProduksi.Text = New DaftarLokasi(ActiveSession).Find(WO.KodeLokasi).NamaLokasi.ToUpper
            Catch
            End Try
        End If
    ...
    Private Sub btSave_Click(sender As Object, e As EventArgs) Handles btSave.Click, btClose.Click
        ...
        Select Case DirectCast(sender, Button).Name
            Case "btSave"
                ...
                If MessageBox.Show("Simpan Data Produksi Jahit ?", "Konfirmasi", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.No Then
                    GoTo Jump
                End If
                ...
                Try
                    ...
                    Dim DaftarProduksiJahit As New DaftarProduksiJahit(ActiveSession)
                    Dim ProduksiJahit As ProduksiJahit
                    Dim UnitProduksi = New DaftarUnitProduksi(ActiveSession).Find(lblKodeUnitProduksi.Tag)

                    NoTransaksi = DaftarProduksiJahit.GetNomorTransaksi(PeriodeTransaksi)
                    ...
                    ProduksiJahit = New ProduksiJahit
                    With ProduksiJahit
                    ...
                    End With
                    DaftarProduksiJahit.Add(ProduksiJahit)
