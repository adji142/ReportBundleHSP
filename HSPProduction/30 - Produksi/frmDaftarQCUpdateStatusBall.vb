...
Public Class frmDaftarQCUpdateStatusBall

    'Form Load
    Private Sub frmDaftarQCUpdateStatusBall_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    'Form Show
    Private Sub frmDaftarQCUpdateStatusBall_Shown(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Shown
        Me.Refresh()
    ...
    'Form Closing
    Private Sub frmDaftarQCUpdateStatusBall_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
    ...
    Private Sub ShowData(Optional ByVal ID As String = "")
        ...
        Dim DataSet As DataSet = DaftarStockBall.Read(txtCariData.Text, cboStatus.ComboBox.SelectedIndex, cboLokasi.ComboBox.SelectedValue)
    ...
    Private Sub frmDaftarQCUpdateStatusBall_KeyDown(ByVal sender As Object, ByVal e As KeyEventArgs) Handles Me.KeyDown
        ...
        Select Case ID
            Case "btEdit", "btEditCTXM"
                ...
                If cboStatus.SelectedIndex + 1 = 1 Then
                    Dim FormEdit As New frmQCInspeksiBall(DataKey)
                    FormEdit.ShowDialog()
                ...
                If cboStatus.SelectedIndex + 1 = 2 Then
                    Dim FormEdit As New frmQCDisposisiBall(DataKey)
                    FormEdit.ShowDialog()
