...
Public Class frmPemakaianBahanAcct
...
#Region "Header Section"
    ...
    Private Sub FillCombo()
        ...
        cboShift.DataSource = DS.Tables("View")
        cboShift.DisplayMember = "Nama Shift"
        cboShift.ValueMember = "Kode"
...
Jump:
    ...
    Private Sub Data_Change(sender As Object, e As EventArgs) Handles txtNoTransaksi.TextChanged,
        ...
        If ObjectName = "cboShift" Then
            Try
                txtKodeShift.Text = cboShift.SelectedValue.ToString
            Catch ex As Exception
            End Try
            'If cboNomorSpk.SelectedIndex <> -1 Then
        ...
        Select Case DirectCast(sender, Button).Name
            Case "btSave"
                ...
                Try
                    ...
                    HeaderPemakaianBahan.TglTransaksi = txtTglPencatatan.Value.Date
                    HeaderPemakaianBahan.TglPencatatan = Now
                    ...
                    For Row = 0 To Grid.GridLastRow - 1
                        ...
                        If Grid.GridValue(_KodeItem, Row) <> "" Then
                            ...
                            If Grid.GridValue(_Qty, Row) < 0 Then
                                SAPStaging.PostMaterialReceipt(KodeUnitSap, cboNomorSpk.SelectedValue, txtTglPencatatan.Value.Date, Grid.GridValue(_KodeItem, Row), Math.Abs(Grid.GridValue(_Qty, Row)), Math.Abs(Grid.GridValue(_Qty, Row)), "", txtNoTransaksi.Text, KodeLokasi)
                            Else
                                SAPStaging.PostMaterialIssue(KodeUnitSap, cboNomorSpk.SelectedValue, txtTglPencatatan.Value.Date, Grid.GridValue(_KodeItem, Row), Grid.GridValue(_Qty, Row), "", txtNoTransaksi.Text, KodeLokasi)
                            End If
...
Jump:
    ...
    Private Sub SetEnableCommand()
        ...
        btSave.Enabled = If(txtNoTransaksi.Text = "", False, True) And _
                         ...
                         If(cboShift.SelectedIndex = -1, False, True) And _
