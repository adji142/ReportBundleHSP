...
Public Class frmExecuteRMIssue
    ...
    Private Sub btSave_Click(sender As Object, e As EventArgs) Handles btSave.Click
        ...
        SAP.UpdateStagingRMIssue(txtNoTransaksi.Text.Trim)
        '-----------------------------------------------------------------------------------

        'Execute From Staging
        SAP.Execute(txtNoTransaksi.Text, HSPProduction.SAPStaging.enumTransaction.MaterialIssue)
