...
Public Class frmDaftarPembatalanPackingKarung

    'Form Load
    Private Sub frmDaftarPembatalanPackingKarung_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Try
            cboKodeLokasi.ComboBox.SelectedValue = GetSetting(enumFormID.frmPackingKarung, enumSetting.settingKodeLokasi)
    ...
    'Form Show
    Private Sub frmDaftarPembatalanPackingKarung_Shown(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Shown
        Me.Refresh()
    ...
    'Form Closing
    Private Sub frmDaftarPembatalanPackingKarung_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
    ...
    Private Sub ShowData(Optional ByVal ID As String = "")
        ...
        Catch
            KodeLokasi = ""
        End Try
        Dim DataSet As DataSet = DaftarStockPacking.ReadStock(txtCariData.Text, 1, KodeLokasi)
    ...
    Private Sub frmDaftarPembatalanPackingKarung_KeyDown(ByVal sender As Object, ByVal e As KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub Execute(ByVal ID As String)
        ...
        Select Case ID
            Case "btDelete", "btDeleteCTXM"
                ...
                '---------------------------------------------------------------------------------------------------------
                Dim FormDelete As New frmPembatalanPackingKarung(DataKey)
