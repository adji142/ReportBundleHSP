...
Public Class frmMonitoringBahanProduksiWO

    'Form Load
    Private Sub frmMonitoringBahanWO_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    'Form Show
    Private Sub frmMonitoringBahanWO_Shown(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Shown
        Me.Refresh()
    ...
    'Form Closing
    Private Sub frmMonitoringBahanWO_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
    ...
    Private Sub ShowData(Optional ByVal ID As String = "")
        ...
        Dim KodeUnitSAP = UnitProduksi.KodeUnitSAP
        Dim KodeLokasi = UnitProduksi.KodeLokasi
        ...
        Dim DataSet As DataSet = New SAPPPIC().ReadMonitoringBahanProduksiWO(txtCariData.Text, KodeUnitSAP, KodeLokasi)
    ...
    Private Sub frmMonitoringBahanWO_KeyDown(ByVal sender As Object, ByVal e As KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub View_RowPostPaint(sender As Object, e As DataGridViewRowPostPaintEventArgs) Handles View.RowPostPaint
        ...
        If Me.View.Rows(e.RowIndex).Cells("Kebutuhan Bahan").Value = 0 Then
            Me.View.Rows(e.RowIndex).DefaultCellStyle.BackColor = Color.LightGreen
        End If

        If Me.View.Rows(e.RowIndex).Cells("Rencana Bahan").Value < Me.View.Rows(e.RowIndex).Cells("Pemakaian Bahan").Value Then
