...
Public Class frmMonitoringBahanProduksi
    'Form Load
    ...
    Private Sub ShowData(Optional ByVal ID As String = "")
        ...
        Dim KodeLokasi = New DaftarUnitProduksi(ActiveSession).Find(cboKodeUnit.ComboBox.SelectedValue).KodeLokasi

        Dim MonPPIC As New SAPPPIC()
        Dim BS As New BindingSource
        Dim DataSet As DataSet = MonPPIC.ReadMonitoringBahanProduksiWO(txtCariData.Text, KodeUnitSAP, KodeLokasi)
