...
Public Class frmRPT910_110_StockRollRewind
    ...
    Private Sub btRefresh_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btRefresh.Click
        ...
        Select Case cboLaporan.SelectedIndex + 1
            Case 1
                RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\Reports\RPT910111_StockRollRewind.RPT")
            Case 2
                RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\Reports\RPT910112_StockRollRewind.RPT")
            Case 3
                RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\Reports\RPT910113_StockRollRewind.RPT")
        End Select
        ...
        'Parameter
        RPTObject.ParameterFields("KodeUnit").CurrentValues.AddValue(GetSetting(enumFormID.frmRewind, enumSetting.settingKodeUnit))
