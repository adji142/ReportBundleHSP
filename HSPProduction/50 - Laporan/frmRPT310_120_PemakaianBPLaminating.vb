...
Public Class frmRPT310_120_PemakaianBPLaminating
    ...
    Private Sub btRefresh_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btRefresh.Click
        ...
        Select Case cboLaporan.SelectedIndex + 1
            Case 1
                RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\Reports\RPT310121_PemakaianBPLaminating.RPT")
            Case 2
                RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\Reports\RPT310122_PemakaianBPLaminating.RPT")
            Case 3
                RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\Reports\RPT310123_PemakaianBPLaminating.RPT")
        End Select
        ...
        RPTObject.ParameterFields("KodeUnit").CurrentValues.AddValue(GetSetting(enumFormID.frmLaminating, enumSetting.settingKodeUnit))
