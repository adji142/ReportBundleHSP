...
Public Class frmRPT320_110_StockRollPrinting
    ...
    Private Sub btRefresh_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btRefresh.Click
        ...
        Select Case cboLaporan.SelectedIndex + 1
            Case 1
                RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\Reports\RPT320111_StockRollPrinting.RPT")
            Case 2
                RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\Reports\RPT320112_StockRollPrinting.RPT")
        End Select
        ...
        'Parameter
        RPTObject.ParameterFields("KodeUnit").CurrentValues.AddValue(GetSetting(enumFormID.frmPrintingRoll, enumSetting.settingKodeUnit))
