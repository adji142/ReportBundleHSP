...
Public Class frmRPT312_140_SisaRollCementBag
    ...
    Private Sub btRefresh_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btRefresh.Click
        ...
        Select Case cboLaporan.SelectedIndex + 1
            Case 1
                RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\Reports\RPT312141_SisaRollCementBag.RPT")
            Case 2
                RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\Reports\RPT312142_SisaRollCementBag.RPT")
            Case 3
                RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\Reports\RPT312143_SisaRollCementBag.RPT")
            Case 4
                RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\Reports\RPT312144_SisaRollCementBag.RPT")
            Case 5
                RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\Reports\RPT312145_SisaRollCementBag.RPT")
            Case 6
                RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\Reports\RPT312146_SisaRollCementBag.RPT")
            Case 7
                RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\Reports\RPT312147_SisaRollCementBag.RPT")
        End Select
        ...
        RPTObject.ParameterFields("Grup").CurrentValues.AddValue(If(cboGrup.ComboBox.Text = "-", "", cboGrup.ComboBox.Text))
