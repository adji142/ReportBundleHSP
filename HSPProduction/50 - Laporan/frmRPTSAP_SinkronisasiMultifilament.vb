...
Public Class frmRPTSAP_SinkronisasiMultifilament
    ...
    Private Sub btRefresh_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btRefresh.Click
        ...
        Select Case cboLaporan.SelectedIndex + 1
            Case 1
                RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\Reports\LAPORAN SINKRONISASI PERSEDIAAN - BENANG MULTIFILAMENT.rpt")
            Case 2
                RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\Reports\LAPORAN SINKRONISASI PERSEDIAAN - BENANG MULTIFILAMENT 2.rpt")
        End Select
