...
Public Class frmRPT311_110_StockRollSlitting
    ...
    Private Sub btRefresh_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btRefresh.Click
        ...
        Select Case cboLaporan.SelectedIndex + 1
            Case 1
                RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\Reports\RPT311111_StockRollSlitting.RPT")
            Case 2
                RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\Reports\RPT311112_StockRollSlitting.RPT")
        End Select
        ...
        'Parameter
        RPTObject.ParameterFields("KodeUnit").CurrentValues.AddValue(GetSetting(enumFormID.frmSlitting, enumSetting.settingKodeUnit))
