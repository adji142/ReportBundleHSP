...
Public Class frmRPTSAP_200_BackOrderPenjualan
    ...
    Private Sub btRefresh_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btRefresh.Click
        ...
        Select Case cboLaporan.SelectedIndex + 1
            Case 1
                RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\Reports\LapBackOrderPenjualan.RPT")
            Case 2
                RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\Reports\LapBackOrderPenjualan2.RPT")
        End Select
        ...
        RPTObject.ParameterFields("Status").CurrentValues.AddValue(cboStatus.ComboBox.SelectedItem)
