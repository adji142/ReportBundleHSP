...
Public Class frmRPT324_110_StockHasilInner
    ...
    Private Sub btRefresh_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btRefresh.Click
        ...
        'Report
        RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\Reports\rpt324111_StockHasilInner.RPT")
        ...
        'Parameter
        RPTObject.ParameterFields("KODELOKASI").CurrentValues.AddValue(GetSetting(enumFormID.frmInner, enumSetting.settingKodeLokasi))
