...
Public Class frmRPT200_170_AnalisaBerat
    ...
    Private Sub FillCombo()
        ...
        cboUnitProduksi.ComboBox.SelectedValue = GetSetting(enumFormID.frmCircularLoom, enumSetting.settingKodeUnit)
    ...
    Private Sub btRefresh_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btRefresh.Click
        ...
        'Report
        RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\Reports\rpt200170_AnalisaBeratRoll.RPT")
