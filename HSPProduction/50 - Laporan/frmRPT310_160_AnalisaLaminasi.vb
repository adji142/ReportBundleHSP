...
Public Class frmRPT310_160_AnalisaLaminasi
    ...
    Private Sub FillComboNomorSPK()
        ...
        DS = New DataSet
        DS = SAPWorkOrder.ReadFGWorkOrderByUnit(New DaftarUnitProduksi(ActiveSession).Find("003").KodeUnitSAP)
    ...
    Private Sub btRefresh_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btRefresh.Click
        ...
        Select Case cboLaporan.SelectedIndex + 1
            Case 1
                RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\Reports\rpt310361_AnalisaLaminasi.RPT")
            Case 2
                RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\Reports\rpt310362_AnalisaLaminasi.RPT")
            Case 3
                RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\Reports\rpt310363_AnalisaLaminasi.RPT")
            Case 4
                RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\Reports\rpt310364_AnalisaLaminasi.RPT")
            Case 5
                RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\Reports\rpt310365_AnalisaLaminasi.RPT")
            Case 6
                RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\Reports\rpt310366_AnalisaLaminasi.RPT")
            Case 7
                RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\Reports\rpt310367_AnalisaLaminasi.RPT")
        End Select
        ...
        RPTObject.ParameterFields("NomorWO").CurrentValues.AddValue(If(cboNomorWO.ComboBox.Text = "-", "", cboNomorWO.ComboBox.Text))
    ...
    Private Sub btLookupNomorWO_Click(sender As Object, e As EventArgs) Handles btLookupNomorWO.Click
        ...
        Dim Parameter() As String = {SAPWorkOrder.enumLookupWorkOrder.woDaftarFGAktifAll, New DaftarUnitProduksi(ActiveSession).Find("003").KodeUnitSAP}
