...
Public Class frmRPT200_140_AnalisaProduksiLoomByMesin
    ...
    Private Sub btRefresh_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btRefresh.Click
        ...
        Select Case cboLaporan.SelectedIndex + 1
            Case 1
                RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\Reports\rpt200141_AnalisaProduksiLoomByMesin.RPT")
            Case 2
                RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\Reports\rpt200142_AnalisaProduksiLoomByMesin.RPT")
        End Select
