...
Public Class frmReprintBarcodeLaminasi
    ...
    Private Sub txtKodeProduksiBahan_Validating(sender As Object, e As System.ComponentModel.CancelEventArgs) Handles txtKodeProduksiBahan.Validating
        If txtKodeProduksiBahan.Text <> "" Then
            Dim KodeUnit = GetSetting(enumFormID.frmLaminating, enumSetting.settingKodeUnit)

            Dim DaftarPL As New DaftarProduksiLaminasi(ActiveSession)
            Dim PL As ProduksiLaminasi = DaftarPL.FindFGKodeProduksiByRMKodeProduksi(txtKodeProduksiBahan.Text.Trim)
