...
Jump:
    ...
    Private Sub Grid_UserAddedRow(sender As Object, e As DataGridViewRowEventArgs)
        SetEnableCommand()
    End Sub

    Private Sub Grid_UserDeletedRow(sender As Object, e As DataGridViewRowEventArgs)
        SetEnableCommand()
    End Sub
    ...
    Private Sub frmPengeluaranBarang_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
        Grid.SaveColumnOrder()
        Me.Dispose()
    End Sub

    Private Sub frmPengeluaranBarang_Shown(sender As Object, e As EventArgs) Handles Me.Shown
        Me.Refresh()
        Grid.SettingID = Me.Name
        Grid.SetColumnOrder()
    End Sub

    Private Sub frmPengeluaranBarang_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ResetData()
    End Sub
    ...
    Private Sub Button_Click(sender As Object, e As EventArgs) Handles btSave.Click, btClose.Click
        ...
        Select Case DirectCast(sender, Button).Name
            Case "btSave"
                ...
                'Try
                '    Dim DaftarPHP As New DaftarPengeluaranBarang(ActiveSession)
                '    Dim HeaderPHP As New HeaderPengeluaranBarang
                '    Dim DetailPHP As New DetailPengeluaranBarang
