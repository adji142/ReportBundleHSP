...
Public Class frmDaftarStockBenang
    ...
    Private Sub ShowData(Optional ByVal ID As String = "")
        ...
        Dim DataSet As DataSet = DaftarSB.ReadTransaction(txtTglAwal.Value.Date, txtTglAkhir.Value.Date, txtCariData.Text)
    ...
    Private Sub Execute(ByVal ID As String)
        ...
        Select Case ID
            Case "btEdit", "btEditCTXM"
                ...
                Dim FormEdit As New frmKoreksiStockBenang(DataKey)
                FormEdit.ShowDialog()
