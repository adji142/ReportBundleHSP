...
Public Class frmDaftarStockBMF
    ...
    Private Sub ShowData(Optional ByVal ID As String = "")
        ...
        Dim DataSet As DataSet = DaftarSB.ReadTransactionBatch(txtTglAwal.Value.Date, txtTglAkhir.Value.Date, txtCariData.Text)
    ...
    Private Sub Execute(ByVal ID As String)
        ...
        Select Case ID
            Case "btEdit", "btEditCTXM"
                ...
                Dim FormEdit As New frmKoreksiStockBMF(DataKey)
                FormEdit.ShowDialog()
