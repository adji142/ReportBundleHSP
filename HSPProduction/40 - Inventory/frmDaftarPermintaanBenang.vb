...
Public Class frmDaftarPermintaanBenang
    ...
    Private Sub ShowData(Optional ByVal ID As String = "")
        ...
        Dim DataSet As DataSet = DaftarPermintaanBenang.Read(txtCariData.Text, txtTglAwal.Value.Date, txtTglAkhir.Value.Date)
    ...
    Private Sub Execute(ByVal ID As String)
        ...
        Select Case ID
            Case "btAdd", "btAddCTXM"
                ...
                '---------------------------------------------------------------------------------------------------------
                Dim FormAdd As New frmPermintaanBenang("")
                FormAdd.ShowDialog()
            ...
            Case "btEdit", "btEditCTXM"
                ...
                Dim FormEdit As New frmPermintaanBenang(DataKey)
                FormEdit.ShowDialog()
