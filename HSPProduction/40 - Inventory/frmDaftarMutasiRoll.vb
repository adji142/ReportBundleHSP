...
Public Class frmDaftarMutasiRoll
    ...
    Private Sub ShowData(Optional ByVal ID As String = "")
        ...
        Dim DataSet As DataSet = DaftarMutasiRoll.Read(txtCariData.Text, txtTglAwal.Value.Date, txtTglAkhir.Value.Date)
    ...
    Private Sub Execute(ByVal ID As String)
        ...
        Select Case ID
            Case "btAdd", "btAddCTXM"
                ...
                '---------------------------------------------------------------------------------------------------------
                Dim FormAdd As New frmMutasiRoll("")
                FormAdd.ShowDialog()
                ...
                '    Dim FormEdit As New frmMutasiRoll(DataKey)
                '    FormEdit.ShowDialog()
