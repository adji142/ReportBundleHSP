...
Public Class frmDaftarStockRoll
    Private WithEvents txtTglAwal As New DateTimePicker
    Private WithEvents txtTglAkhir As New DateTimePicker

    'Form Load
    Private Sub frmDaftarPermintaanBenang_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    'Form Show
    Private Sub frmDaftarPermintaanBenang_Shown(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Shown
        Me.Refresh()
    ...
    'Form Closing
    Private Sub frmDaftarPermintaanBenang_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
    ...
    Private Sub ShowData(Optional ByVal ID As String = "")
        ...
        'Baca Data
        Dim DaftarSR As New DaftarStockRoll(ActiveSession)
        Dim BS As New BindingSource
        Dim DataSet As DataSet = DaftarSR.ReadTransactionProduksiLoom(txtTglAwal.Value.Date, txtTglAkhir.Value.Date, txtCariData.Text)
    ...
    Private Sub frmDaftarPermintaanBenang_KeyDown(ByVal sender As Object, ByVal e As KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub Execute(ByVal ID As String)
        ...
        Select Case ID
            Case "btEdit", "btEditCTXM"
                ...
                Dim FormEdit As New frmKoreksiStockRoll(DataKey)
                FormEdit.ShowDialog()
