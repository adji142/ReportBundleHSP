...
Public Class frmLookup
    ...
    Public IDLookup1 As String = ""
    Public IDLookup2 As String = ""
    ...
    Private Sub btOK_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btOK.Click
        ...
        IDLookup1 = View(1, View.CurrentCell.RowIndex).Value
        If View.ColumnCount > 2 Then
            IDLookup2 = View(2, View.CurrentCell.RowIndex).Value
        End If
        If View.Columns(0).HeaderText = "RowID" Then
