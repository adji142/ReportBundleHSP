...
Public Class frmDaftarOJT
    ...
    'Form Load
    Private Sub frmDaftarOJT_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    'Form Show
    Private Sub frmDaftarOJT_Shown(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Shown
        Me.Refresh()
    ...
    'Form Closing
    Private Sub frmDaftarOJT_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
    ...
    Private Sub ShowData(Optional ByVal ID As String = "")
        ...
        Dim DataSet As DataSet = DaftarOJT.ReadTransaction(Periode, txtCariData.Text, cboBagian.ComboBox.SelectedValue.ToString, cboDept.ComboBox.SelectedValue.ToString)
    ...
    Private Sub frmDaftarOJT_KeyDown(ByVal sender As Object, ByVal e As KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub Execute(ByVal ID As String)
        ...
        Select Case ID
            Case "btAdd", "btAddCTXM"
                ...
                '---------------------------------------------------------------------------------------------------------
                Dim FormAdd As New frmOJT("", cboBagian.ComboBox.SelectedValue)
                FormAdd.ShowDialog()
            ...
            Case "btEdit", "btEditCTXM"
                ...
                Dim FormEdit As New frmOJT(DataKey, cboBagian.ComboBox.SelectedValue)
