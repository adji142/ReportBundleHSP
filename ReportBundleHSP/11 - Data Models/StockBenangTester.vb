...
Namespace HSP.Data
    Public Class StockBenangTester
    ...
    Public Class DaftarStockBenangTester
        ...
        Public Function Add(ByVal Data As StockBenangTester) As Integer
            Dim SQL As String

            SQL = "INSERT INTO stockbenangtester " +
        ...
        Public Function Edit(ByVal Data As StockBenangTester) As Integer
            Dim SQL As String

            SQL = "UPDATE stockbenangtester SET " +
        ...
        Public Function Find(ByVal ID As String) As StockBenangTester
            Dim SQL As String

            SQL = "SELECT * FROM stockbenangtester " +
                  "WHERE KodeProduksi = @KodeProduksi AND StatusTransaksi=1"

            Using DBX As IDbConnection = _DBConnection.Connection
                Find = DBX.Query(Of StockBenangTester)(SQL, New With {.KodeProduksi = ID}).FirstOrDefault
            End Using
        End Function

        Public Function FindExist(ByVal ID As String) As StockBenangTester
            Dim SQL As String
            ...
            Using DBX As IDbConnection = _DBConnection.Connection
                FindExist = DBX.Query(Of StockBenangTester)(SQL, New With {.KodeProduksi = ID}).FirstOrDefault
            End Using
        End Function

        Public Function FindLastID() As StockBenangTester
            Dim SQL As String
            ...
            Using DBX As IDbConnection = _DBConnection.Connection
                FindLastID = DBX.Query(Of StockBenangTester)(SQL).FirstOrDefault
            End Using
        End Function

        Public Function FindByNoTimbang(ByVal NoTimbang As String) As StockBenangTester
            Dim SQL As String
            ...
            SQL = "SELECT " +
                  ...
                  "Keterangan " +
                  "FROM stockbenangtester " +
                  "WHERE M_NoTimbang = @M_NoTimbang AND K_NoTimbang='' " +
                  "GROUP BY M_NoTimbang "

            Using DBX As IDbConnection = _DBConnection.Connection
                FindByNoTimbang = DBX.Query(Of StockBenangTester)(SQL, New With {.M_NoTimbang = NoTimbang}).FirstOrDefault
            End Using
        End Function

        Public Function FindByNoWO(ByVal NomorWO As String) As StockBenangTester
            Dim SQL As String
            ...
            Using DBX As IDbConnection = _DBConnection.Connection
                FindByNoWO = DBX.Query(Of StockBenangTester)(SQL, New With {.NomorWO = NomorWO}).FirstOrDefault
            End Using
        End Function
        ...
        Public Function GetNomorTransaksiIn(ByVal Periode As String) As String
            ...
            Using DBX As IDbConnection = _DBConnection.Connection()
                ...
                SQL = "SELECT MAX(RIGHT(M_NoTimbang,5)) AS Total FROM stockbenangtester " +
        ...
        Public Function GetKodeProduksi(KodeUnit As String, ByVal KodeMesin As String, ByVal Periode As String, PrefikParam As String) As String
            Dim SQL As String
            'Dim Prefik, Nomor, Temp As String
            ...
            Using DBX As IDbConnection = _DBConnection.Connection()
                ...
                Prefik = PrefikParam & Periode

                SQL = "SELECT COUNT(KodeProduksi) AS Total FROM stockbenangtester " +
                      "WHERE LEFT(KodeProduksi, LENGTH(@Prefik)) = @Prefik "

                'Temp = (DBX.Query(SQL, New With {.Prefik = Prefik}).FirstOrDefault.Total + 1).ToString
                'Nomor = Temp.PadLeft(13 - Prefik.Length).Replace(" ", "0")

                Temp = (DBX.Query(SQL, New With {.Prefik = Prefik}).FirstOrDefault.Total + 1)
            End Using
            'GetKodeProduksi = Prefik + KodeMesin + Nomor
            GetKodeProduksi = Temp
        ...
        Public Function GetNomorTransaksiOut(ByVal Periode As String) As String
            ...
            Using DBX As IDbConnection = _DBConnection.Connection()
                ...
                SQL = "SELECT MAX(RIGHT(K_NoTimbang,5)) AS Total FROM stockbenangtester " +
