...
Namespace HSP.Data
    ...
    Public Class DaftarProduksiJahit
        ...
        'Add
        '------------------------------------------------------------------------------------------------------------------
        Public Function Add(ByVal Data As ProduksiJahit) As Integer
            Dim SQL As String

            SQL = "INSERT INTO produksijahit" +
                  "     (RowID, " +
        ...
        Public Function GetNomorTransaksi(ByVal Periode As String) As String
            ...
            Using DBX As IDbConnection = _DBConnection.Connection()
                ...
                'Nomor Transaksi
                '------------------------------------------------------------------------------------------
                SQL = "SELECT COUNT(*) AS Total FROM produksijahit " +
