...
Namespace HSP.Data
    Public Class KoreksiStockBMF
        ...
        Public Property JmlConesLama As Double
    ...
    Public Class DaftarKoreksiBMF
        ...
        Public Function Add(ByVal Data As KoreksiStockBMF) As Integer
            Dim SQL As String

            SQL = "INSERT INTO koreksistockbmf " +
                  "(RowID, NoTransaksi, TglTransaksi, NoRef, KodeGrupLama, KodeMesinLama, KodeStatusLama, KeteranganLama, JmlConesLama, KodeGrupBaru, " +
                  "KodeMesinBaru, KodeStatusBaru, KeteranganBaru, JmlConesBaru, AlasanPerubahan, UserID, TRX) " +
                  "VALUES " +
                  "(REPLACE(UUID(),'-',''), @NoTransaksi, @TglTransaksi, @NoRef, @KodeGrupLama, @KodeMesinLama, @KodeStatusLama, @KeteranganLama, @JmlConesLama, @KodeGrupBaru, " +
                  "@KodeMesinBaru, @KodeStatusBaru, @KeteranganBaru, @JmlConesBaru, @AlasanPerubahan, @UserID, '" + TRX() + "')"
