...
Public Class FrmRPT_BackOrderPenjualanMakasar
    ...
    Private Sub btRefresh_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btRefresh.Click
        ...
        Select Case cboTipeLaporan.SelectedIndex + 1
            Case 1
                RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\Reports\Rpt02BO_BackorderPenjualanMakasar.RPT")
            Case 2
                RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\Reports\Rpt02BO_BackorderPenjualanMakasar.RPT")
        End Select
