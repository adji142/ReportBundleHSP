...
Public Class FrmRPT_BackOrderPenjualanLombok
    ...
    Private Sub btRefresh_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btRefresh.Click
        ...
        With Server
            ...
            .DatabaseName = "xadistribusilombok"
            .UserID = DBX.UserID
        ...
        Select Case cboTipeLaporan.SelectedIndex + 1
            Case 1
                RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\Reports\Rpt01BO_BackorderPenjualanLombok.RPT")
            Case 2
                RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\Reports\Rpt02BO_BackorderPenjualanLombok.RPT")
        End Select
        ...
        Select Case CmbStatus.SelectedIndex
            Case 0
                RPTObject.ParameterFields("statustrx").CurrentValues.AddValue(DBNull.Value)
            Case 1
                RPTObject.ParameterFields("statustrx").CurrentValues.AddValue(0)
            Case 2
                RPTObject.ParameterFields("statustrx").CurrentValues.AddValue(1)
        End Select
