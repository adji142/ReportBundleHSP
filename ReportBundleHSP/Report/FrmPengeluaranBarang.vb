...
Public Class FrmPengeluaranBarang
    ...
    Private Sub btRefresh_Click(sender As Object, e As EventArgs) Handles btRefresh.Click
        ...
        Select Case cboLaporan.SelectedIndex + 1
            ...
            Case 3
                RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\Reports\Rpt110113_GudangBenang.RPT")
            Case 4
                RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\Reports\Rpt110114_GudangBenang.RPT")
        End Select
