...
Public Class Rpt110111_GudangBenang
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Rpt110111_GudangBenang.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ReportBundleHSP.Rpt110111_GudangBenang.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt110111_GudangBenang
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt110111_GudangBenang = New Rpt110111_GudangBenang()
        rpt.Site = Me.Site
        Return rpt
    End Function
