...
Public Class Plugin_KedatanganBarang
    ...
    Public Sub Execute()
        ...
        Dim Title = "Laporan Kedatangan Barang 3 Hari Terakhir " + vbCrLf + "Per " + _Date.ToString("dd/MM/yyyy hh:mm")
    ...
    Public Function _Create()
        Try
            ...
            Dim FileName As String = "PRC02" & Now.Ticks.ToString & ".PDF"
            ...
            RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\Rpt_PluginLaporanKedatanganBarang.rpt")
            ...
            RPTObject.ParameterFields("TGLAWAL@").CurrentValues.AddValue(DateAdd(DateInterval.Day, -3, _Date))
            RPTObject.ParameterFields("TGLAKHIR@").CurrentValues.AddValue(_Date) '
            RPTObject.ParameterFields("TRANSAKSI@").CurrentValues.AddValue("10")
            RPTObject.ParameterFields("LOKASI@").CurrentValues.AddValue("")
