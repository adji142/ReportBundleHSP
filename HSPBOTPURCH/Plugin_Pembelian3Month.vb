...
Public Class Plugin_Pembelian3Month
    ...
    Public Sub Execute()
        ...
        Dim Title = "Laporan Pembelian 3 Bulan Terakhir " + vbCrLf + "Per " + _Date.ToString("dd/MM/yyyy hh:mm")
    ...
    Public Function _Create()
        Try
            ...
            Dim FileName As String = "PRC01" & Now.Ticks.ToString & ".PDF"
            ...
            RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\Rpt_PluginLaporanPembelian.rpt")
            ...
            RPTObject.ParameterFields("DATEFROM@").CurrentValues.AddValue(DateAdd(DateInterval.Month, -3, _Date))
            RPTObject.ParameterFields("DATETO@").CurrentValues.AddValue(_Date) '
