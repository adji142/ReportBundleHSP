...
Public Class Plugin_PemakaianObat_Rekap
    ...
    Public Sub Execute()
        ...
        Dim Title = "Laporan Rekap Pemakaian Obat " + vbCrLf + "Per " + _Date.ToString("dd/MM/yyyy hh:mm")
    ...
    Public Function _Create()
        Try
            ...
            Dim FileName As String = "GA04" & Now.Ticks.ToString & ".PDF"
            ...
            RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\Rpt_PluginPemakaianObat_Rekap.rpt")
