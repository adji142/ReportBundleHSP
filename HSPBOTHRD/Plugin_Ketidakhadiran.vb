...
Public Class Plugin_Ketidakhadiran
    ...
    Public Function _Create()
        Try
            ...
            Dim FileName As String = "HRD03" & Now.Ticks.ToString & ".PDF"
            ...
            RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\HRDKetidakhadiran.rpt")
