...
Public Class Plugin_DataKaryawan
    ...
    Public Sub Execute()
        ...
        Dim Title = "Laporan Data Karyawan" + vbCrLf + "Per " + _Date.ToString("dd/MM/yyyy hh:mm")
    ...
    Public Function _Create()
        Try
            ...
            Dim FileName As String = "HRD02" & Now.Ticks.ToString & ".PDF"
            ...
            RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\HRDDataKaryawan.rpt")
